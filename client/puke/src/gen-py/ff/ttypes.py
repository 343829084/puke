...
class join_table_req_t:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I16, 'table_index', None, 0, ), # 1
  )

  def __init__(self, table_index=thrift_spec[1][4],):
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.I16:
          self.table_index = iprot.readI16();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('join_table_req_t')
    if self.table_index is not None:
      oprot.writeFieldBegin('table_index', TType.I16, 1)
      oprot.writeI16(self.table_index)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class join_talbe_ret_t:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRUCT, 'room_info_ret', (room_info_ret_t, room_info_ret_t.thrift_spec), None, ), # 1
  )

  def __init__(self, room_info_ret=None,):
    self.room_info_ret = room_info_ret
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRUCT:
          self.room_info_ret = room_info_ret_t()
          self.room_info_ret.read(iprot)
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('join_talbe_ret_t')
    if self.room_info_ret is not None:
      oprot.writeFieldBegin('room_info_ret', TType.STRUCT, 1)
      self.room_info_ret.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class chagne_turn_ret_t:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I16, 'turn_index', None, 0, ), # 1
  )

  def __init__(self, turn_index=thrift_spec[1][4],):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('chagne_turn_ret_t')
    if self.turn_index is not None:
      oprot.writeFieldBegin('turn_index', TType.I16, 1)
      oprot.writeI16(self.turn_index)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
